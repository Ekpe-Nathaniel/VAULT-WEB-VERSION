        ...
        >
          <GlassCard variant="intense" className="p-8 sm:p-10">
            ...
            <div className="space-y-3 mb-6">
              <Button variant="outline" size="md" className="w-full" onClick={async () => { setGoogleLoading(true); try { await signInWithGoogle(); navigate('/embed') } catch { setGoogleLoading(false) } }} loading={googleLoading}>
